...
# WGS84 coordinate range of the US.
lon_min, lat_min = -125.974, 30.038
lon_max, lat_max = -68.748, 52.214

# Querying the open sky network API
user_name = ''
password = ''
...
# convert json html data to a df
...
# Defining function to convert WGS84 coordinates to web mercator point
...
# converting flight_df coordinates to web mercator
...
# get a label for each point when hovered over
my_hover = HoverTool()
