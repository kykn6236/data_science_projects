# the actual tutorial https://www.geodose.com/2020/08/create-flight-tracking-apps-using-python-open-data.html
#IMPORTING LIBRARY
import requests
import json
import pandas as pd
...
# Defining function to convert GCS WGS84 labels to web mercator point
